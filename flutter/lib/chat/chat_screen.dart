...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void _sendMessage() {
    if (_controller.text.trim().isNotEmpty ||
      ...
      setState(() {
        ...
        if (_image != null) {
          _messages
              .add({"text": null, "isMe": true, "imagePath": _image!.path});

          _image = null; // Xóa ảnh sau khi gửi
        }
        if (_recordedFilePath != null) {
          _messages.add(
              {"text": null, "isMe": true, "audioPath": _recordedFilePath});
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                        fontSize: screenWidth * 0.03, color: Color(0xFF9AA5AC)),
                  ),
                  SizedBox(
                    height: 10,
                  ),
  ...
  Widget buildMessageContent(
      String message, String? imagePath, String? audioPath, bool isMe) {
    if (message.isNotEmpty) {
      ...
      return FutureBuilder<Duration>(
        future: _audioDurations.containsKey(audioPath)
              ...
              Padding(
                ...
                child: CircleAvatar(
                  ...
                  backgroundImage: NetworkImage(
                      "https://i.pravatar.cc/150?img=3"), // Ảnh giả lập
                ),
              ),
              Text(
                "Cuộc gọi đến",
